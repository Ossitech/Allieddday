...
--*****************************************************************************
--* File: C:\work\rts\main\data\maps\X1CA_001\X1CA_001_strings.lua
...
OPERATION_NAME = 'Operation: D-Day'
...
IntroDialog = {
  {text = 'Der Commander hat das Wort.', vid = 'intro.sfd', bank = 'DDayVO', cue = 'intro', faction = 'UEF'},
}
AttackDialog = {
  {text = 'Ok Leute, Feind in Sicht! Distanz: 4 Kilometer!', vid = 'attacking.sfd', bank = 'DDayVO', cue = 'attacking', faction = 'UEF'},
}
DefeatDialog = {
  {text = 'Verkackt!', vid = 'usa.sfd', bank = 'DDayVO', cue = 'usa', faction = 'Cybran'},
}
X01_M01_010 = {
